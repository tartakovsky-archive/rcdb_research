...
def test_adx(test_dataset):
    ...
    assert tulip.adx.inputs == {'high', 'low'}
...
def test_bbands(test_dataset):
    ...
    assert tulip.bbands.inputs == {'open', 'high', 'low', 'close'}
...
def test_bop(test_dataset):
    ...
    assert tulip.bop.inputs == {'open', 'high', 'low', 'close'}
...
def test_cci(test_dataset):
    ...
    assert tulip.cci.inputs == {'high', 'low', 'close'}
...
def test_macd(test_dataset):
    ...
    assert tulip.macd.inputs == {'series'}
...
def test_obv(test_dataset):
    ...
    assert tulip.obv.inputs == {'series', 'volume'}
...
def test_psar(test_dataset):
    ...
    assert tulip.psar.inputs == {'open', 'high', 'low', 'close'}
...
def test_roc(test_dataset):
    ...
    assert tulip.roc.inputs == {'series'}
...
def test_rsi(test_dataset):
    ...
    assert tulip.rsi.inputs == {'series'}
...
def test_stoch(test_dataset):
    ...
    assert tulip.stoch.inputs == {'high', 'low', 'close'}
...
def test_willr(test_dataset):
    ...
    assert tulip.willr.inputs == {'high', 'low', 'close'}
