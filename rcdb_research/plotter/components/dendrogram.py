...
def dendrogram(model,
    ...
    ax_kwargs = {
        **style.ax_kwargs(
            yformatter=None,
            xtickrotation=90 if h_or_v == 'v' else 0,
    ...
    plot_dendrogram(linkage_matrix, labels=labels, color_threshold=model.distance_threshold,
                    orientation=orientation, ax=axis, **dendrogram_kwargs)
