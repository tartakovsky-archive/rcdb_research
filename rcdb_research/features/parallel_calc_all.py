...
from rcdb_research.utils import np_to_file, np_from_file, kwargs_to_str, json_from_file, \
    json_to_folder, chunks, FnSerializer, AttrDict, generate_constraints_function
from rcdb_research.features.transformations import TransformObj, Transforms, TransformsMixin, TransformDelayed
...
class JobManager:
    ...
    def run_job(self):
        if self.job_meta['n_jobs'] == 1:
            ...
            command = f"{python_path} -c 'from rcdb_research.features.parallel_calc_all import" \
