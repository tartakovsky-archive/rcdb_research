...
from ..features import tulip
from ..job_manager import km, t, col


window = npext.expstep_range(3, 50, 10, step_mult=0.03)
short_period = npext.expstep_range(2, 25, 5, step_mult=0.03)
long_period = npext.expstep_range(5, 40, 5, step_mult=0.03)
